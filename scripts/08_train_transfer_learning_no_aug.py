#!/usr/bin/env python3
"""
Transfer Learning with ResNet50 WITHOUT augmentation (baseline)
...
def main():
    ...
    for epoch in range(FINETUNE_EPOCHS):
        ...
        if val_acc > best_val_acc:
            ...
            }, MODEL_DIR / 'resnet50_finetuned_no_aug.pth')
    ...
    checkpoint = torch.load(MODEL_DIR / 'resnet50_finetuned_no_aug.pth')
